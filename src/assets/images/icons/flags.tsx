...
import esct from "./flags/es-ct.svg";
import esga from "./flags/es-ga.svg";
...
import india from "./flags/in.svg";
...
// TODO move to "@/constants/entity-related.tsx" ?
interface MappedCountryDetails extends MappedDetails {
  // base64 of the SVG (used in <img src={base64} />)
  icon: string;
}
const COUNTRY_DETAILS: {
  [key: string]: MappedCountryDetails;
} = {
  ad: {
    label: "Andorre",
    icon: ad,
...
export const COUNTRIES_AS_ARRAY = Object.keys(COUNTRY_DETAILS).map((flag) => ({
  value: flag,
  ...COUNTRY_DETAILS[flag],
}));
