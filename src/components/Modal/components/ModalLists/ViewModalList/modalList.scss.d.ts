declare namespace ModalListScssNamespace {
  export interface IModalListScss {
    Disabled: string;
    Divider: string;
    Flex: string;
...
declare const ModalListScssModule: ModalListScssNamespace.IModalListScss & {
  /** WARNING: Only available when `css-loader` is used without `style-loader` or `mini-css-extract-plugin` */
  locals: ModalListScssNamespace.IModalListScss;
};

export = ModalListScssModule;
