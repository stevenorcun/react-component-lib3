...
import { getEntityStrIcon, getEntityTypeColor } from '@/constants/entity-related';
import { isDark } from '@/utils/colors';
import cx from 'classnames';
import styles from './styles.scss';

const Label = ({
  contentState, entityKey, blockKey, children,
}: any) => {
  ...
  const [currentFontSize, setCurrentFontSize] = useState<number | undefined>(undefined);
  ...
  useEffect(() => {
    ...
    const previousFontSizeKey = contentBlock.getInlineStyleAt(0).findLast((v, key) => {
